...
parser.add_argument('--gpu', default=0, type=int,
                    help='GPU id to use.')
parser.add_argument('--root_log', type=str, default='student_log_imagenet')
parser.add_argument('--root_model', type=str, default='student_checkpoint_imagenet')
...
parser.add_argument('--root', default='D:\\Datasets\\ImageNet2012\\', help='dataset setting')
...
def main():
    ...
    args.store_name = '_'.join(
        [args.dataset, args.arch, args.loss_type, args.train_rule, args.imb_type,
         str(args.imb_factor), 'T' + str(args.T), args.exp_str, '0614zuixin'])
...
def load_network(network, args):
    ...
    save_path = 'teacher_checkpoint/Imagenet-LT_resnet50_CE_None_exp_0.02_0/ckpt.pth.tar'
    if args.model_dir:
