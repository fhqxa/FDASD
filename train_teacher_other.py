...
parser.add_argument('--dataset', default='voc19', help='dataset setting')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # switch_defer, switch_resample, switch_reweight = comparison0.Rebalance('None')
    #
    # train_loader, val_loader, _ = dataset0.DataloaderFromDataset(
    #     train_dataset, test_dataset, percls, percls_test, switch_resample,defer_epoch=0, batch_size=args.batch_size, epoch=0)
